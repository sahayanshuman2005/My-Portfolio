  ...
  return (
    <motion.div
      ...
      className={[
        ...
        isDragging
          ? "scale-[1.03] shadow-2xl shadow-black/60 border-white/30 opacity-80 z-50"
          : "hover:scale-[1.02] hover:border-white/20 hover:shadow-2xl hover:shadow-black/50",
      ].join(" ")}
    >
      <div
        {...attributes}
        ...
        className="
          ...
          touch:opacity-100          /* always visible on touch screens */
          hover:bg-black/80
          select-none
        "
      ...
      <div className="flex flex-col flex-grow p-4 sm:p-5 md:p-6">
        ...
        <p className="text-xs sm:text-sm md:text-base text-white/60 leading-relaxed mb-3 sm:mb-4 line-clamp-3">
          {description}
        </p>
